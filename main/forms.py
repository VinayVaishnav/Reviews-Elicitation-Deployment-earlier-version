...
class ReviewForm(forms.ModelForm):
    problem_solving = forms.CharField(required=True, widget=forms.Textarea(attrs={'class': 'problem_solving-textarea', 'placeholder': 'Write about problem solving skills here...'}))
    communication = forms.CharField(required=True, widget=forms.Textarea(attrs={'class': 'communication-textarea', 'placeholder': 'Write about communicational skills here...'}))
    sociability = forms.CharField(required=True, widget=forms.Textarea(attrs={'class': 'sociability-textarea', 'placeholder': 'Write about sociability here...'}))
