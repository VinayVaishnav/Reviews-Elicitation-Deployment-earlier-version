...
class Review(models.Model):
    ...
    problem_solving_bool = models.BooleanField(default=True)
    communication_bool = models.BooleanField(default=True)
    sociability_bool = models.BooleanField(default=True)
